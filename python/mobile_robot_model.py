...
"""
Author: Wei Luo
Date: 2025-04-24 11:30:12
LastEditors: Wei Luo
LastEditTime: 2026-01-07 11:29:45
Note: Note
"""
"""
Author: Wei Luo
...
class MobileRobotModel(object):
    def __init__(
        ...
        # function
        f = ca.Function(
            "f", [states, controls], [ca.vcat(rhs)], ["state", "control_input"], ["rhs"]
        )
        # f_expl = ca.vcat(rhs)
        # acados model
        ...
        constraint.x_min = -2.0
        constraint.x_max = 2.0
        constraint.y_min = -2.0
        constraint.y_max = 2.0
